...
import { countryData } from '../stores/countriesData';
...
const ResumeForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (isLoaded && user) {
      // Update user metadata indicating form is filled
  ...
  return (
    ...
    >
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700">Preferred Job Countries</label>
        <select
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700">Preferred Job States</label>
        <select
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700">Preferred Job Cities</label>
        <select
      ...
      <button
        type="submit"
        className="w-full py-3 px-4 bg-blue-500 text-white rounded-md shadow-sm hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500"
      >
        Submit
      </button>
    </form>
